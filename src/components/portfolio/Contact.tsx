...
import { Mail, Github, Linkedin, Phone, Send, MessageCircle, Code2, Terminal, BookOpen } from "lucide-react";
...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSending(true);
    try {
      await emailjs.send("YOUR_SERVICE_ID", "YOUR_TEMPLATE_ID", { from_name: form.name, reply_to: form.email, message: form.message }, "YOUR_PUBLIC_KEY");
